...
export default async function EditExpensePage({
  ...
  return (
    <>
      <TrackPage path={`/groups/${groupId}/expenses/${expenseId}/edit`} />
      <div className="min-h-[80dvh] flex flex-col">
        ...
        <div className="relative mb-6 rounded-xl border border-blue-100/20 dark:border-blue-900/15 bg-white/50 dark:bg-white/[0.03] backdrop-blur-sm p-4 sm:p-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-heading font-bold text-xl">Edit Expense</h1>
              <p className="text-xs text-muted-foreground mt-0.5">Update expense details</p>
            </div>
          </div>
        </div>
