...
import { ChevronRight, Equal, Hash, LucideIcon, Percent, Save, SplitSquareHorizontal } from 'lucide-react'
  ...
  return (
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(submit)}>
        <Card className="border-blue-100/20 dark:border-blue-900/15 bg-white/50 dark:bg-white/[0.03] backdrop-blur-sm">
          <CardHeader>
            <CardTitle>
        ...
        <Card className="mt-4 border-blue-100/20 dark:border-blue-900/15 bg-white/50 dark:bg-white/[0.03] backdrop-blur-sm">
          <CardHeader>
              ...
              <CollapsibleContent>
                <div className="grid sm:grid-cols-2 gap-6 pt-3">
                  <FormField
                    ...
                    name="splitMode"
                    render={({ field }) => {
                      const modes: { value: string; label: string; icon: LucideIcon; desc: string }[] = [
                        { value: 'EVENLY', label: 'Evenly', icon: Equal, desc: 'Split equally' },
                        { value: 'BY_SHARES', label: 'By Shares', icon: Hash, desc: 'Per person shares' },
                        { value: 'BY_PERCENTAGE', label: 'By %', icon: Percent, desc: 'Percentage split' },
                        { value: 'BY_AMOUNT', label: 'By Amount', icon: SplitSquareHorizontal, desc: 'Custom amounts' },
                      ]
                      return (
                        <FormItem>
                              ...
                              {modes.map((mode) => {
                                ...
                                return (
                                  <button
                                    ...
                                    type="button"
                                    onClick={() => {
                                      form.setValue('splitMode', mode.value as any, {
                                        shouldDirty: true,
                                        shouldTouch: true,
                                        shouldValidate: true,
                                      })
                                    ...
                                    className={cn(
                                      'relative rounded-xl border p-3 flex flex-col items-center gap-1.5 transition-all duration-200 cursor-pointer',
                                      isActive
                                        ? 'border-blue-500 dark:border-blue-400 bg-blue-50 dark:bg-blue-950/30 shadow-sm shadow-blue-500/10'
                                        : 'border-blue-100/30 dark:border-blue-900/20 bg-white/40 dark:bg-white/[0.03] hover:border-blue-300/40 dark:hover:border-blue-700/40 hover:bg-blue-50/30 dark:hover:bg-blue-950/20',
                                    )}
                                  >
                                    <div className={cn(
        ...
        <div className="flex mt-4 gap-2">
          <SubmitButton loadingContent={t(isCreate ? 'creating' : 'saving')} className="bg-gradient-to-br from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white shadow-lg shadow-blue-500/20 dark:shadow-blue-600/15 transition-all duration-300">
