  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Help keep <strong>JointSettle</strong> free and without ads!
        </p>
      </div>
      <div className="prose prose-sm dark:prose-invert">
        <p>
          JointSettle is offered for free, but costs money and energy. If you like
          the app, you can choose to support it by sponsoring me (Sebastien) or
          with a one-time small donation.
        </p>
        <p>By supporting JointSettle:</p>
        <ul>
          <li>
